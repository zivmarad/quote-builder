      ...
      <main className="min-h-screen bg-[#F8FAFC]" dir="rtl">
        <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6">
            <p className="text-slate-700 font-medium mb-4 text-center">מחירונים פופולריים</p>
            <div className="flex flex-wrap justify-center gap-2.5 text-sm mb-5">
              {popularPriceLists.map((priceList) => (
                <Link
                  key={priceList.slug}
            ...
            <div className="flex flex-wrap justify-center gap-3 text-sm border-t border-slate-100 pt-5">
              <Link
                href="/guides"
                className="px-4 py-2 rounded-xl bg-slate-100 text-slate-700 font-medium hover:bg-slate-200 transition-colors"
              >
