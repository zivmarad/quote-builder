...
const faq = [
  {
    ...
    answer:
      'בעמוד זה לוחצים על כל כרטיס (Word, Excel או PDF). נפתחת בחירה: להוריד תבנית ריקה למילוי ידני, או לבנות הצעה ממותגת עם לוגו ופרטים באפליקציה. התבניות עצמן חינמיות וללא הרשמה.',
  },
  {
      ...
      <main className="min-h-screen bg-[#F8FAFC]" dir="rtl">
        <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          ...
          <p className="text-slate-500 text-sm mb-4">
            חינם וללא הרשמה. בלחיצה תבחרו: תבנית ריקה למילוי ידני, או הצעה ממותגת עם לוגו וכל הפרטים.
          </p>
