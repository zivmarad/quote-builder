...
## עידכון על הרשמה חדשה (מייל / טלפון)

בכל הרשמה חדשה נשלח **מייל** עם פרטי הנרשם (אימייל, שם משתמש, תאריך). אפשר לשלוח למייל הפרטי ו/או לטלפון (SMS):

- **NOTIFY_ADMIN_EMAIL** – כתובת המייל שלך. אם מוגדר – העדכון נשלח לכאן (במקום או בנוסף ל־EMAIL_USER).
- **NOTIFY_SMS_EMAIL** – אימייל שמגיע כ־SMS לטלפון. פורמט: `מספר@ספק`, למשל:
  - סלקום: `0501234567@cellcom.co.il`
  - פרטנר: `0501234567@partner.co.il`
  - פלאפון: `0501234567@pelephone.net.il`
  - גולן: `0501234567@golan-telecom.co.il`  
  (חפש "email to sms" של הספק שלך אם אין ברשימה.)

אם **לא** הגדרת אף אחד מהם – העדכון נשלח ל־`EMAIL_USER` כמו עד עכשיו.
